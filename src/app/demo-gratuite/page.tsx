...
export default function DemoPage() {
  return (
    <PageHero
      ...
      subtitle="Dites-nous qui vous êtes et on vous rappelle pour planifier une courte démo : voix québécoise, tableau de bord et réponses à vos questions. Sans engagement, sans carte de crédit."
    ...
    >
      <p className="mt-6 max-w-[600px] text-center text-[0.9375rem] leading-relaxed text-text-secondary mx-auto lg:mt-8">
        Vous aimez mieux qu&apos;on vous rappelle sans remplir le formulaire?
        Écrivez-nous à{" "}
        <TrackedEmailLink
